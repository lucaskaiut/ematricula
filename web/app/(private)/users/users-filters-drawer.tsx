    ...
    pickerOpen && typeof document !== 'undefined'
      ? createPortal(
          <div
            ...
            className="users-filters-daypicker w-max max-w-[calc(100vw-1rem)] rounded-xl border border-slate-200 bg-white p-4 shadow-2xl [--rdp-accent-color:#2563eb] [--rdp-background-color:#dbeafe]"
          >
            <DayPicker
              mode="range"
              selected={value}
