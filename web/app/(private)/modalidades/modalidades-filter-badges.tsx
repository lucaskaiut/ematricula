...
export type ModalitiesFilterBadgesProps = {
...
export function ModalitiesFilterBadges({
  state,
  onClearName,
  onClearDescription,
  onClearCreatedRange,
  onClearUpdatedRange,
}: ModalitiesFilterBadgesProps) {
  ...
  if (state.description.trim()) {
    items.push({
      key: 'description',
      label: `Descrição: ${state.description.trim()}`,
      onRemove: onClearDescription,
    });
  }
