    ...
    pickerOpen && typeof document !== 'undefined'
      ? createPortal(
          <div
            ...
            className="persons-filters-daypicker w-max max-w-[calc(100vw-1rem)] rounded-xl border border-border bg-card p-4 shadow-2xl [--rdp-accent-color:var(--primary)] [--rdp-background-color:var(--accent-soft)]"
          >
            <DayPicker
              mode="range"
              selected={value}
